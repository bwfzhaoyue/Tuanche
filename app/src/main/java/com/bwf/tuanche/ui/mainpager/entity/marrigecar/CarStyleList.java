 ...
 * Description:Tuanche
 */
public class CarStyleList implements Parcelable {
    public String id;
    ...
    protected CarStyleList(Parcel in) {
    ...
    public static final Parcelable.Creator<CarStyleList> CREATOR = new Parcelable.Creator<CarStyleList>() {
        @Override
        public CarStyleList createFromParcel(Parcel source) {
            return new CarStyleList(source);
        }

        @Override
        public CarStyleList[] newArray(int size) {
            return new CarStyleList[size];
        }
    };
}
