...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	private AnimationDrawable anim_pull_to_refresh;//正在刷新帧动画
	// 下拉头
	...
	public void refreshFinish(int refreshResult)
	{
		...
		default:
			...
			refreshStateImageView
					.setBackgroundResource(R.mipmap.loading_error);
			break;
		}
		if (pullDownY > 0)
		{
			...
			}.sendEmptyMessageDelayed(0, resultDuration);
		} else
		{
			changeState(DONE);
			hide();
	...
	public void loadmoreFinish(int refreshResult)
	{
		...
		default:
			...
			loadStateImageView.setBackgroundResource(R.mipmap.loading_error);
			break;
		}
		if (pullUpY < 0)
		{
...
//			pullView.startAnimation(rotateAnimation);
	...
	private void initView()
	{
		...
		anim_pull_to_refresh = (AnimationDrawable) refreshingView.getBackground();
